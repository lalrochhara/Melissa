...
PM_START_TEXT = """
*ʜᴇʏ* {}, [🥀](https://i.ibb.co/6DD9HM9/images.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="❄ ᴀʙᴏᴜᴛ ❄", callback_data="Melissa_"),
        InlineKeyboardButton(text="✨ sᴜᴩᴩᴏʀᴛ ✨", url=f"https://t.me/{SUPPORT_CHAT}"),
    ],
    [
        InlineKeyboardButton(text="🥀 ᴅᴇᴠᴇʟᴏᴩᴇʀ 🥀", url=f"tg://user?id={OWNER_ID}"),
        InlineKeyboardButton(text="Terms of Use", callback_data="source_"),
    ],
]

HELP_STRINGS = f"""
*» {BOT_NAME} ᴇxᴄʟᴜsɪᴠᴇ ꜰᴇᴀᴛᴜʀᴇs*[❤️](https://i.ibb.co/6DD9HM9/images.jpg)
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Melissa.modules." + module_name)
...
def Melissa_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "Melissa_":
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
            text=f"*ʜᴇʏ,*[🥀](https://i.ibb.co/6DD9HM9/images.jpg)\n  *ᴛʜɪs ɪs {BOT_NAME}*"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="Melissa_support"
                        ),
                        InlineKeyboardButton(
    ...
    elif query.data == "Melissa_support":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            url="https://github.com/lalrochhara",
                        ),
                    ],
                    [
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=f"""
*ʜᴇʏ,
 ᴛʜɪs ɪs {BOT_NAME}, [❤️](https://i.ibb.co/6DD9HM9/images.jpg)
,
...
*ʜᴇʀᴇ ɪs ᴍʏ Terms of Use :* [ɢɪᴛʜᴜʙ](https://github.com/lalrochhara/Melissa)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/lalrochhara/Melissa/blob/master/LICENSE).
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                ...
                photo=START_IMG,
                caption=f"""
ㅤ[❤️](https://i.ibb.co/6DD9HM9/images.jpg)
