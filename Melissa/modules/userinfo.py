...
import Melissa.modules.sql.userinfo_sql as sql
from Melissa import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Melissa.__main__ import STATS, TOKEN, USER_INFO
from Melissa.modules.disable import DisableAbleCommandHandler
from Melissa.modules.helper_funcs.chat_status import sudo_plus
from Melissa.modules.helper_funcs.extraction import extract_user
from Melissa.modules.sql.global_bans_sql import is_user_gbanned
from Melissa.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/MelissaAssociation/7"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/MelissaAssociation/8"
                            ),
                        ],
                    ]
                ),
