...
from Melissa import dispatcher
from Melissa.modules.disable import (
    DisableAbleCommandHandler,
    DisableAbleMessageHandler,
)
from Melissa.modules.sql import afk_sql as sql
from Melissa.modules.users import get_user_id
